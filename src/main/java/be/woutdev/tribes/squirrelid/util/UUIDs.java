...
package be.woutdev.tribes.squirrelid.util;
...
public final class UUIDs
{
    ...
    private static final Pattern DASHLESS_PATTERN = Pattern.compile(
    ...
    /**
     * Add dashes to a UUID. <p> <p>If dashes already exist, the same UUID will be returned.</p>
     *
     * @param uuid the UUID
     *
