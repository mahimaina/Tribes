...
/**
 * Combines several {@code ProfileService}s together and checks them from first to last, stopping when there are no more
 * services left to query or all profiles were found.
 */
