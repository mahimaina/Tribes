...
public interface ProfileService
{
    ...
    /**
     * Get the optimal maximum number of profiles that can be found with one {@link #findAllByName(Iterable)} call. <p>
     * <p>{@link #findAllByName(Iterable)} (and similar) methods may split up requests into smaller ones to fit within
     * one request. This method returns the ideal maximum number.</p>
     *
