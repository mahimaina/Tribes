...
package be.woutdev.tribes.squirrelid;
...
/**
 * A pairing of a user's UUID and his or her username. <p> <p>Two profile objects are equal if they have the same
 * UUID.</p>
 */
public final class Profile
{
    ...
    public boolean equals(Object o)
    {
        ...
        if (!uniqueId.equals(profile.uniqueId))
        {
            return false;
        }
